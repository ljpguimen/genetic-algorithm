...
import people
import msvcrt
# import Yong_justTest_mirror_functions as mirror_f # This is for the DM at far table.
import mirror_functions as mirror_f # Use this if you want to use the DM at LWFA table, and comment the above line.
...
ADF_FOLDER = 'C:\\Users\lambdacubed\Desktop\Mark\genetic_algorithm_python\saved_mirrors\\'     # directory for mirror actuator files
FOM_GRAPH_FOLDER = 'C:\\Users\lambdacubed\Desktop\Mark\genetic_algorithm_python\saved_graphs\\'    # directory for figure of merit graphs
...
def genetic_algorithm():
    ...
    print('Press the enter key (or r then enter) to run the program')
